...
export const decodeAuction = (buffer: Buffer) => {
  return deserializeUnchecked(AUCTION_SCHEMA, AuctionData, buffer);
};
...
export const decodeBidderPot = (buffer: Buffer) => {
  return deserializeUnchecked(AUCTION_SCHEMA, BidderPot, buffer);
};
...
export const decodeAuctionDataExtended = (buffer: Buffer) => {
  return deserializeUnchecked(AUCTION_SCHEMA, AuctionDataExtended, buffer);
};
...
export const decodeBidderMetadata = (buffer: Buffer) => {
  return deserializeUnchecked(AUCTION_SCHEMA, BidderMetadata, buffer);
};
